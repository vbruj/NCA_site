        ...
        <v-container pa-2>
          ...
          <v-card outlined style="padding: 15px 15px 15px 15px ;">
            ...
            <v-layout row wrap fill-height>
              ...
              <v-flex col-sm-5 col-md-5 col-lg-5 col-12>
                <v-text-field outlined disabled placeholder=" " v-model="data['kadastr_nomer_zy']" ></v-text-field>
              </v-flex>
            </v-layout>
            <v-layout row wrap align-baseline>
              <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
        ...
        <v-container pa-2>
          ...
          <v-card outlined style="padding: 15px 15px 0px 15px ;">
            ...
            <v-layout row wrap fill-height>
              ...
              <v-flex class="col-sm-5 col-md-5 col-lg-5 col-xl-5 col-12">
                <v-text-field outlined disabled v-model="data2['vent']"></v-text-field>
              </v-flex>
              <v-flex class="col-sm-5 col-md-5 col-lg-5 col-xl-5 col-12">
                <v-select
                  :items="tip_ventil"
        ...
        <v-container pa-2>
          ...
          <v-card outlined style="padding: 15px 15px 0px 15px ;">
            <v-layout row wrap align-baseline>
              ...
              <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12"></v-flex>
            </v-layout>
...
export default {
    ...
    this.$nextTick(function() {
      setTimeout(() => {
        ymaps.ready(function() {
          ...
          var naznachenieks = document.getElementById("naznachenieks").value;
          ...
          // Создание метки 
              ...
              {
                iconContent: "Объект",
                balloonContent: naznachenieks + ", " + adress
              },{
  ...
  methods: {
    ...
    save_data(){
      ...
      if (((i<=0) && (i2<=0) && (this.data2['date_sost_tehpas'] != '') && (this.data2['data_obsled'] != '') && (this.data2['data_akta'] != ''))){  
          ...
          axios
            .post(
              "https://82.202.204.7:3333/api/areas/save/Object_vvedeni_v_eksplyataciu_PS",
              this.data2
            )
            .then(res => {
    ...
    get_inf: async function() {
      ...
      var self = this;
      const BD = await axios.get("https://82.202.204.7:3333/PS");
      for (let i = 0; i <= BD.data.length; i++) {
        try{
          if (nomer == BD.data[i].inv_num) {          
            ...
            self.data2["vent"] = BD.data[i].vent;
