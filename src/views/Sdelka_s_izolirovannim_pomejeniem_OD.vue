    ...
    <v-container  >
      ...
      <v-container pa-2>
        ...
        <v-card outlined style="padding: 15px 15px 0px 15px ;">
          ...
          <v-layout row wrap >
            ...
            <v-flex class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-12">
              <v-select
                ...
                outlined
                :clearable="clearable" 
                v-model="data2['mat_sten2']"
                placeholder="  "
                label="Заполнить"
                ref="mat_sten2"
                :rules="[() => !!data2['mat_sten2'] || 'Это поле обязательно к заполнению']"
                :error-messages="errorMessages"
                required
              ></v-select>
            </v-flex>
          ...
          <v-layout row wrap >
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <span>Материал кровли капитального строения (по преобладающей площади)</span>
            </v-flex>
            <v-flex class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-12">
              <v-combobox 
                outlined 
                :items="material_krovli" 
                :clearable="clearable" 
          ...
          <v-layout row wrap >
            ...
            <v-flex class="col-sm-2 col-md-2 col-lg-2 co l-xl-2 col-12">
...
export default {
  ...
  computed: {
    form () {
      return {
        ...
        mat_sten2	: this.data2['mat_sten2'],	
  ...
  methods: {
    ...
    get_inf: async function() {
      ...
      var self = this;
      const BD = await axios.get("https://82.202.204.7:3333/ODIP");
      ...
      for (let i = 0; i <= BD.data.length; i++) {
        try{
          ...
          self.data2["mat_sten2"] = BD.data[i].mat_sten2 == null ? '' : BD.data[i].mat_sten2;
    ...
    save_data(){
      ...
      if (((i<=0) && (i2<=0) && (this.data2['data_obsled'] != '') )){  
          ...
          axios
            .post(
              "https://82.202.204.7:3333/api/areas/save/Sdelka_s_izolirovannim_pomejeniem_OD",
              this.data2
            )
            .then(res => {
